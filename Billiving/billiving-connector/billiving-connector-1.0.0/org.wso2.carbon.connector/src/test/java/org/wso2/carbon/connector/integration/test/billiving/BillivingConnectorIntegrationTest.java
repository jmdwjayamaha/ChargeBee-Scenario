...
public class BillivingConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testCreateClientWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getString("Id"), clientId);
    ...
    public void testCreateClientWithOptionalParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getString("Id"), clientId2);
        Assert.assertEquals(apiRestResponse.getBody().getString("Email"), connectorProperties.get("clientEmail"));
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateClientWithNegativeCase" }, description = "Billiving {getClient} integration test with mandatory parameters.")
    public void testGetClientWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getString("ContactName"), esbRestResponse.getBody().getString("ContactName"));
        Assert.assertEquals(apiRestResponse.getBody().getString("OrganizationName"), esbRestResponse.getBody().getString("OrganizationName"));
     ...
     */
    @Test(priority = 1, dependsOnMethods = { "testGetClientWithMandatoryParameters" }, description = "Billiving {getFile} integration test with negative case.")
    public void testGetClientWithNegativeCase() throws IOException, JSONException {
       ...
       String apiEndPoint = apiUrl + "/api2/v1/clients/Invalid";
       RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetClientWithNegativeCase" }, description = "Billiving {listClients} integration test with mandatory parameters.")
    ...
    public void testCreateInvoiceWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getString("Uri"), esbRestResponse.getBody().getString("Uri"));
    ...
    public void testGetInvoiceWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(apiRestResponse.getBody().getString("IssueDate"), esbRestResponse.getBody().getString("IssueDate"));
        Assert.assertEquals(apiRestResponse.getBody().getString("CurrencyId"), esbRestResponse.getBody().getString("CurrencyId"));
        Assert.assertEquals(apiRestResponse.getBody().getString("ClientId"), esbRestResponse.getBody().getString("ClientId"));
    }
    
    /**
     * Negative test case for getInvoice method.
     */
    @Test(priority = 1, dependsOnMethods = { "testGetInvoiceWithMandatoryParameters" }, description = "Billiving {getInvoice} integration test with negative case.")
    public void testGetInvoiceWithNegativeCase() throws IOException, JSONException {
       ...
       String apiEndPoint = apiUrl + "/api2/v1/invoices/Invalid";
       RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetInvoiceWithNegativeCase" }, description = "Billiving {listInvoices} integration test with mandatory parameters.")
